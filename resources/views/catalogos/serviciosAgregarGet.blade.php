        ...
        <div class="col-md-10">
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body p-4">
                    <h1 class="display-5 mb-4 text-center" style="color: #6f42c1; font-family: 'Nunito', sans-serif; font-weight: 700;">Agregar Nuevo Servicio</h1>
                    ...
                    <form method="POST" action="{{ url('/catalogos/servicios/agregar') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('estado_pago') is-invalid @enderror" id="estado_pago" name="estado_pago" required>
                                <option value="1" {{ old('estado_pago') == '1' ? 'selected' : '' }}>Activo</option>
                                <option value="0" {{ old('estado_pago', '0') == '0' ? 'selected' : '' }}>Inactivo</option>  
                            </select>
                            @error('estado_pago')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <button type="submit" class="btn btn-sm text-white" style="background-color: #6f42c1;">Guardar Servicio</button>
                        </div>
                    </form>
                </div>
            </div>
