        ...
        <div class="col-md-10">
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body p-4">
                    <h1 class="display-5 mb-4 text-center" style="color: #6f42c1; font-family: 'Nunito', sans-serif; font-weight: 700;">Agregar Nuevo Cliente</h1>
                    ...
                    <form method="POST" action="{{ url('/catalogos/clientes/agregar') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('RFC') is-invalid @enderror" id="RFC" name="RFC" value="{{ old('RFC') }}" maxlength="13" pattern="[A-Za-z0-9]{1,13}" title="El RFC debe contener máximo 13 caracteres alfanuméricos">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <button type="submit" class="btn btn-sm text-white" style="background-color: #6f42c1;">Guardar Cliente</button>
                        </div>
                    </form>
                </div>
            </div>
